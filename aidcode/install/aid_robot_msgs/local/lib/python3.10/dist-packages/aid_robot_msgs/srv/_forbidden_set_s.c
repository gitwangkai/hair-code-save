...
bool aid_robot_msgs__srv__forbidden_set__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aid_robot_msgs.srv._forbidden_set.ForbiddenSet_Request", full_classname_dest, 54) == 0);
  }
  aid_robot_msgs__srv__ForbiddenSet_Request * ros_message = _ros_message;
  {  // map_id
...
{
  /* NOTE(esteve): Call constructor of ForbiddenSet_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aid_robot_msgs.srv._forbidden_set");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ForbiddenSet_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool aid_robot_msgs__srv__forbidden_set__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aid_robot_msgs.srv._forbidden_set.ForbiddenSet_Response", full_classname_dest, 55) == 0);
  }
  aid_robot_msgs__srv__ForbiddenSet_Response * ros_message = _ros_message;
  {  // success
...
{
  /* NOTE(esteve): Call constructor of ForbiddenSet_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aid_robot_msgs.srv._forbidden_set");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ForbiddenSet_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
