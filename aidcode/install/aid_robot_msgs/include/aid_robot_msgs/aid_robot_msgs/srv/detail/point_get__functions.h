...
#ifndef AID_ROBOT_MSGS__SRV__DETAIL__POINT_GET__FUNCTIONS_H_
#define AID_ROBOT_MSGS__SRV__DETAIL__POINT_GET__FUNCTIONS_H_
...
/// Initialize srv/PointGet message.
/**
...
/// Create srv/PointGet message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * aid_robot_msgs__srv__PointGet_Request__init().
...
/// Destroy srv/PointGet message.
/**
 * It calls
 * aid_robot_msgs__srv__PointGet_Request__fini()
...
/// Check for srv/PointGet message equality.
/**
...
/// Initialize array of srv/PointGet messages.
/**
...
/// Finalize array of srv/PointGet messages.
/**
 * It calls
 * aid_robot_msgs__srv__PointGet_Request__fini()
...
/// Create array of srv/PointGet messages.
/**
 * It allocates the memory for the array and calls
 * aid_robot_msgs__srv__PointGet_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/PointGet messages.
/**
 * It calls
 * aid_robot_msgs__srv__PointGet_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/PointGet message array equality.
/**
...
/// Copy an array of srv/PointGet messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * aid_robot_msgs__srv__PointGet_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_aid_robot_msgs
...
/**
 * It calls
 * aid_robot_msgs__srv__PointGet_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_aid_robot_msgs
...
/**
 * It allocates the memory for the array and calls
 * aid_robot_msgs__srv__PointGet_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_aid_robot_msgs
...
/**
 * It calls
 * aid_robot_msgs__srv__PointGet_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AID_ROBOT_MSGS__SRV__DETAIL__POINT_GET__FUNCTIONS_H_
