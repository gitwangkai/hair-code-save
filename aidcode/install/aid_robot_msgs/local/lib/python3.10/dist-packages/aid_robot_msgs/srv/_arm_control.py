...
class Metaclass_ArmControl(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from aid_robot_msgs.srv import _arm_control
...
class ArmControl(metaclass=Metaclass_ArmControl):
    from aid_robot_msgs.srv._arm_control import ArmControl_Request as Request
    from aid_robot_msgs.srv._arm_control import ArmControl_Response as Response
