...
#ifndef AID_ROBOT_MSGS__SRV__DETAIL__SET_CURRENT_MAP__FUNCTIONS_H_
#define AID_ROBOT_MSGS__SRV__DETAIL__SET_CURRENT_MAP__FUNCTIONS_H_
 ...
 * calls
 * aid_robot_msgs__srv__SetCurrentMap_Request__init().
...
/**
 * It calls
 * aid_robot_msgs__srv__SetCurrentMap_Request__fini()
...
/// Check for srv/SetCurrentMap message equality.
/**
...
/// Copy a srv/SetCurrentMap message.
/**
 ...
 * aid_robot_msgs__srv__SetCurrentMap_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * aid_robot_msgs__srv__SetCurrentMap_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetCurrentMap message array equality.
/**
...
/// Copy an array of srv/SetCurrentMap messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * aid_robot_msgs__srv__SetCurrentMap_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_aid_robot_msgs
...
/**
 * It calls
 * aid_robot_msgs__srv__SetCurrentMap_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_aid_robot_msgs
...
/**
 * It allocates the memory for the array and calls
 * aid_robot_msgs__srv__SetCurrentMap_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_aid_robot_msgs
...
/**
 * It calls
 * aid_robot_msgs__srv__SetCurrentMap_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AID_ROBOT_MSGS__SRV__DETAIL__SET_CURRENT_MAP__FUNCTIONS_H_
